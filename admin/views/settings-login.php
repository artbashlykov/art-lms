		...
		<div class="art-lms-login-settings-layout">
			<div class="art-lms-login-settings-main">
				<div class="art-lms-panel">
					...
					<p class="description">
						<?php esc_html_e( 'Здесь настраивается собственная страница входа вместо стандартного адреса WordPress wp-login.php. Покупатели и гости сайта будут попадать на выбранный URL. Вместе со страницей входа включается и своя страница сброса / установки пароля (вкладка «Страница пароля»). Выход по-прежнему обрабатывается через wp-login.php.', 'art-lms' ); ?>
					</p>
				</div>
