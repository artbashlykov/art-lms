...
/**
 * Class Art_LMS_Admin_Materials
 */
class Art_LMS_Admin_Materials {

	const PAGE_LIST = 'art-lms-materials';
	...
	/**
	 * Redirect to native materials list.
	 */
	public static function load_list_page() {
		...
		wp_safe_redirect( admin_url( 'edit.php?post_type=' . Art_LMS_Materials::POST_TYPE ) );
		exit;
	}
	...
	public static function ensure_post_type_registered() {
		if ( post_type_exists( Art_LMS_Materials::POST_TYPE ) ) {
			return;
		}
